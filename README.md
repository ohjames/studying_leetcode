...
| 37 | [Sudoku Solver](recursion/37.py) | ${\color{Red}Hard}$ |
...
| 36 | [Valid Sudoku](matrices/36.py) | ${\color{orange}Medium}$ |
...
| 42 | [Trapping Rain Water](stacks/42.py) | ${\color{Red}Hard}$ |
| 84 | [Largest Rectangle in Histogram](stacks/84.py) | ${\color{Red}Hard}$ |
...
| 198 | [House Robber](dynamic-programming/198.py) | ${\color{orange}Medium}$ |
| 300 | [Longest Increasing Subsequence](dynamic-programming/300.py) | ${\color{orange}Medium}$ |
